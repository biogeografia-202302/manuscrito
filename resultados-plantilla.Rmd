...
nombre_odk <- estudiantes_todos_datos %>% 
  filter(`Nombres y apellidos compatible Params` == params$estudiante) %>%
  pull(odk_user)
...
rutas_imagenes <- paste0('odk/biogeografia_hormigas_202302/', mis_forms_campo$foto)
...
spp_odk <- read_excel(
  path = 'odk/biogeografia_hormigas_202302_identificacion.xlsx', sheet = 2, verbose = F) %>% 
