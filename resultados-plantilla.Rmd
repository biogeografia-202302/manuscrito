...
nombre_odk <- estudiantes_todos_datos[
  estudiantes_todos_datos$`Nombres y apellidos compatible Params` == params$estudiante,
  'odk_user', drop = T]
mis_forms <- odk_campo_form_usuario[
  gsub('(uid:)(.*)(\\|.*)', '\\2', odk_campo_form_usuario$`_CREATOR_URI_USER`) == nombre_odk, ]
```

```{r}
mis_forms_campo <- odk_campo[odk_campo$KEY %in% mis_forms$`_URI`, ]
```
